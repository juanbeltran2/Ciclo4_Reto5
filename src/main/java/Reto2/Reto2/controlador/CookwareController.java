...
public class CookwareController {
    ...
    public List<Cookware>getByPriceLessThanEqual(@PathVariable("price")double price){
        return cookwareService.getByPriceLessThanEqual(price);
    }

    @GetMapping("/description/{description}")
    public List<Cookware>getByDescriptionContainingIgnoreCase(@PathVariable("description")String description){
        return cookwareService.getByDescriptionContainingIgnoreCase(description);
    }
}
